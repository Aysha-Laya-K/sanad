...
import 'package:luxury_real_estate_flutter_ui_kit/views/post_property/widgets/change_account_bottom_sheet.dart';
import 'package:luxury_real_estate_flutter_ui_kit/views/post_property/widgets/post_property_country_picker_bottom_sheet.dart';

class PostPropertyView extends StatelessWidget {
  PostPropertyView({super.key});

  PostPropertyController postPropertyController =
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Row(
          //   children: List.generate(postPropertyController.propertyLookingList.length, (index) {
          //     return Expanded(
          //       child: GestureDetector(
          //         onTap: () {
          ...
          //             borderRadius: BorderRadius.circular(AppSize.appSize12),
          //             border: Border.all(
          //               color: postPropertyController.selectPropertyLooking.value == index
          //                   ? AppColor.primaryColor
