...
class AppStyle {
  ...
  static TextStyle serviceName({required Color color}) {
    return _baseStyle(AppSize.appSize16, FontWeight.w500, AppFont.interSemiBold)
        .copyWith(
      color: color,
    );
  }

  static TextStyle servicePlace({required Color color}) {
    return _baseStyle(AppSize.appSize13, FontWeight.w400, AppFont.interMedium)
        .copyWith(
      color: color,
    );
  }
