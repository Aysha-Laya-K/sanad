...
import 'package:luxury_real_estate_flutter_ui_kit/controller/add_amenities_controller.dart';
import 'package:luxury_real_estate_flutter_ui_kit/gen/assets.gen.dart';
import 'package:luxury_real_estate_flutter_ui_kit/routes/app_routes.dart';
import 'package:luxury_real_estate_flutter_ui_kit/views/post_property/post_property_success_view.dart';

class AddAmenitiesView extends StatelessWidget {
  AddAmenitiesView({super.key});

  AddAmenitiesController addAmenitiesController = Get.put(AddAmenitiesController());
                ...
                child: Obx(() {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: addAmenitiesController.selectAmenities.value == index
                ...
                child: Obx(() {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(AppSize.appSize12),
                      border: Border.all(
                        color: addAmenitiesController.selectWaterSource.value == index
                            ? AppColor.primaryColor
                            : AppColor.descriptionColor,
                      ),
                    ),
            ...
            children: List.generate(addAmenitiesController.otherFeaturesList.length, (index) {
              return GestureDetector(
                ...
                child: Row(
                  children: [
                    Obx(() => Image.asset(
                      addAmenitiesController.selectOtherFeatures.value == index
                ...
                child: Obx(() {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(AppSize.appSize12),
                      border: Border.all(
                        color: addAmenitiesController.selectLocationAdvantages.value == index
                            ? AppColor.primaryColor
                            : AppColor.descriptionColor,
                      ),
                    ),
