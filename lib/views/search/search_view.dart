        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              //       searchFilterController.propertyLookingList.length, (index) {
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: List.generate(
                    searchFilterController.propertyTypeList.length, (index) {
                  return GestureDetector(
                    onTap: () {
                    ...
                    child: Obx(() => Container(
                          margin:
                              const EdgeInsets.only(bottom: AppSize.appSize6),
                          padding: const EdgeInsets.symmetric(
                            horizontal: AppSize.appSize16,
                            vertical: AppSize.appSize10,
                          ),
                  ...
                  children: List.generate(
                    ...
                    return GestureDetector(
                      ...
                      child: Obx(() => Container(
                            ...
                            child: Center(
                              child: Text(
                                searchFilterController.amenitiesList[index],
                                style: AppStyle.heading5Medium(
                                  color: searchFilterController
                                              .amenitiesSelec.value ==
                                          index
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Row(
          //   children: List.generate(
          //       searchFilterController.recentSearchedList.length, (index) {
          //     return Container(
          ...
          Wrap(
            ...
            children: List.generate(
                searchFilterController.recentSearched2List.length, (index) {
              return Container(
                margin: const EdgeInsets.only(right: AppSize.appSize16),
                padding: const EdgeInsets.symmetric(
                  vertical: AppSize.appSize10,
