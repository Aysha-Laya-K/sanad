        ...
        children: [
                  ...
                  Obx(() {
                    if (editProfileController.profileImage.value.isNotEmpty) {
                      ...
                      return CircleAvatar(
                        ...
                        backgroundColor: AppColor.whiteColor,
                        backgroundImage:
                            MemoryImage(editProfileController.webImage.value!),
                      );
                    } else {
                      return CircleAvatar(
                        backgroundColor: AppColor.whiteColor,
          ...
          Obx(() => Container(
                padding: EdgeInsets.only(
                  top: editProfileController.hasPhoneNumberFocus.value ||
                          editProfileController.hasPhoneNumberInput.value
                      ? AppSize.appSize6
                      : AppSize.appSize14,
                  bottom: editProfileController.hasPhoneNumberFocus.value ||
                          editProfileController.hasPhoneNumberInput.value
                      ? AppSize.appSize8
                      : AppSize.appSize14,
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: editProfileController.hasPhoneNumberFocus.value ||
                            editProfileController.hasPhoneNumberInput.value
                      ...
                      children: [
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              focusNode:
                                  editProfileController.phoneNumberFocusNode,
                              controller:
          ...
          Obx(() => Container(
                padding: EdgeInsets.only(
                  top: editProfileController.hasPhoneNumber2Focus.value ||
                          editProfileController.hasPhoneNumber2Input.value
                      ? AppSize.appSize6
                      : AppSize.appSize14,
                  bottom: editProfileController.hasPhoneNumber2Focus.value ||
                          editProfileController.hasPhoneNumber2Input.value
                      ? AppSize.appSize8
                      : AppSize.appSize14,
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(AppSize.appSize12),
                  border: Border.all(
                    color: editProfileController.hasPhoneNumber2Focus.value ||
                            editProfileController.hasPhoneNumber2Input.value
                        ? AppColor.primaryColor
                        : AppColor.descriptionColor,
                    // width: AppSize.appSizePoint7,
                      ...
                      children: [
                        editProfileController.hasPhoneNumber2Focus.value ||
                            ...
                            ? SizedBox(
                                ...
                                child: IntrinsicHeight(
                                  child: GestureDetector(
                                    onTap: () {
                                      editSecondCountryPickerBottomSheet(
                                          context);
                                    },
                                    child: Row(
                                      children: [
                        ...
                        Expanded(
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              focusNode:
                                  editProfileController.phoneNumber2FocusNode,
                              controller:
                                  editProfileController.phoneNumber2Controller,
                              cursorColor: AppColor.primaryColor,
                              keyboardType: TextInputType.phone,
                              style: AppStyle.heading4Regular(
                                  color: AppColor.textColor),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: List.generate(
                                editProfileController.whatAreYouHereList.length,
                                (index) {
                              return GestureDetector(
                                onTap: () {
                                  editProfileController
                                      .updateWhatAreYouHere(index);
                                  editProfileController
                                      .toggleWhatAreYouHereExpansion();
                                },
                                child: Row(
                                  children: [
                                    Container(
