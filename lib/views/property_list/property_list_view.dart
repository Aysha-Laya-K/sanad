                ...
                isDataEmpty
                  ...
                  itemBuilder: (context, index) {
                    final property = response
                        .data[index]; // Fetching property details
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        response.data[index].totalRating
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  String agentPhoneNumber = response.data[index]
                                      .agent.phone; // Get dynamically
                                  propertyListController.launchDialer(
                                      agentPhoneNumber);
                                },
                                style: ButtonStyle(
